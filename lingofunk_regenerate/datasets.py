...
class Dataset:
    def __init__(self, emb_dim=50, mbsize=32, get_data_cb=get_sst_data):
        ...
        self.train_iter, self.val_iter, _ = data.BucketIterator.splits(
            (train, val, test), batch_size=mbsize,
...
# df_val.to_csv(os.path.join(data_folder, 'val.csv'), index=False)
#
#
# data_path = os.path.join(
...
# #
# # tst = TabularDataset(
# #     path=data_folder,  # the file path
# #     format='csv',
# #     skip_header=True,
