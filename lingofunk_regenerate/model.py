...
class RNN_VAE(nn.Module):
    ...
    def forward(self, sentence, use_c_prior=True, return_decoded=False):
        """
        Params:
        -------
        ...
        # print(sentence[1:])
        # print(pad_words)
        # print([sentence[1:], pad_words])
        # print(torch.cat([sentence[1:], pad_words], dim=0))
